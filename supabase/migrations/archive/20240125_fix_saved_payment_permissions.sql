...
-- DROP Policies to ensure clean slate (avoids duplicates)
DROP POLICY IF EXISTS "Users can manage their own payment methods" ON public.saved_payment_methods;
DROP POLICY IF EXISTS "Users can read own payment methods" ON public.saved_payment_methods;
